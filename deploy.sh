...
kubectl set image deployments/client-deployment client=shaibad/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=shaibad/multi-worker:$SHA